...
export const linksToComponents: ThePages<Route>[] = [
  ...
  { title: 'Dropdown Submenu', href: '/dropdown-submenu' },
  {
    ...
    href: '/dropdown-and-checkboxes-and-icons'
  },
  ...
  {
    title: 'Dashboard With Table Charts And Sidebar',
    href: '/dashboard-with-table-charts-and-sidebar'
  },
  {
